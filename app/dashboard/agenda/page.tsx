      ...
      <div className="card p-4 md:p-5">
        ...
        <div className="mt-3 flex gap-2">
          {week.map((d) => (
            <div
              key={d.day}
              className="flex flex-1 flex-col items-center rounded-crm bg-muted py-3"
            >
              <span className="text-xs font-medium text-muted-foreground">{d.day.slice(0, 3)}</span>
              <span className="mt-1 text-lg font-semibold text-foreground">{d.count}</span>
